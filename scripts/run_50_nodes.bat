@echo off
REM Runs all 50 swarm nodes in parallel.
REM Usage: run_50_nodes.bat [monitor] [visualize]
...
echo All 50 nodes started! Close the windows to stop.
pause
